...
//
// May send-list (15 brands). June/July are added when those batches launch.
export const SEND_CONTACTS: Record<number, string[]> = {
  ...
  1357: ["raja@psgoodtimes.com"],                                     // P.S. Good Times
  ...
  302:  ["alisha.williams@goodidea.us", "elizabeth.neumann@goodidea.us", "brittany.bettingen@goodidea.us"], // Good Idea
