...
function mockVipBrands(): Brand[] {
  const base = {
    ...
    TOP_PDP: null,
    PDP_COUNT: 0,
    PYLON_LAST_COMMUNICATION_AT: null,
    RECURLY_STATE: null,
    RECURLY_PLAN_NAME: null,
    RECURLY_AMOUNT: null,
    RECURLY_CURRENCY: null,
    RECURLY_CURRENT_PERIOD_STARTED_AT: null,
    RECURLY_CURRENT_PERIOD_ENDS_AT: null,
    RECURLY_CURRENT_TERM_ENDS_AT: null,
    RECURLY_AUTO_RENEW: null,
    RECURLY_BILLING_PORTAL_URL: null,
    ON_REACHOUT_SHEET: false,
    REACHED_OUT: null,
    REACHED_OUT_SEND_LABEL: null,
    ON_SE_SPRINT_SHEET: false,
    SE_SPRINT_SUBMITTED_AT: null,
    SE_SPRINT_MYSHOPIFY_URL: null,
    SE_SPRINT_HAS_SHARED_CODE: null,
    SE_SPRINT_COLLABORATOR_CODE: null,
    SE_SPRINT_MYSHOPIFY_URL_OVERRIDE: null,
    SE_SPRINT_DISMISSED: false,
